    ...
    <div className={darkmode ? "dark" : ""}>
      ...
      <main className='bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen pt-10 pb-32'>
            <nav className='flex justify-between'>
              ...
              <ul className='flex items-center'>
                <li className='dark:text-teal-600'><BsFillMoonStarsFill className="cursor-pointer text-2xl"  onClick={() => setDarkMode(!darkmode)}/></li>
            ...
            <div className='text-center pt-20 md:pt-24 lg:pt-28'>
              <h2 className='font-bold text-4xl text-teal-600 py-2 sm:text-5xl'>Meyzan Al Yutra</h2>
        ...
        <section className='pb-32'>
            ...
            <div className='w-full  md:grid md:grid-cols-2  md:gap-8 lg:gap-12  justify-between  '>
                ...
                <div className='py-4 md:py-2'>
                    <div className='w-full  shadow-xl
                      ...
                      <Image src={web5} alt="web1" width={100} height={100} layout='responsive' />
                    </div>
                </div>
                ...
                <div className='py-4 md:py-2'>
                    <div className='w-full  shadow-xl
                                shadow-slate-700 
                          hover:scale-105 transition-all duration-500 overflow-hidden rounded-lg'>
                      <Image src={web6} alt="web1" width={100} height={100} layout='responsive' />
                    </div>
                </div>
          ...
          {/* <h1 className="text-3xl font-bold underline from-stone-50">
            Hello world!
          </h1> */}
